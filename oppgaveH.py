import subprocess
valg = int(input("tast for hva du vill gjøre med bildet ditt: 1 filter, 2 svart hvitt filter, 3 bilderotasjon, 4 endre størrelse, 5 skriv tekst på bilde, 6 ramme inn bildet"))
if valg == 1:
